...
import id.ac.ui.cs.advprog.tutorial1.newsletter.repository.NewsletterRepositoryImpl;
import id.ac.ui.cs.advprog.tutorial1.newsletter.repository.UserRepositoryImpl;
...
public class NewsletterController {
    ...
    public String handleNewBroadcast(Model model, @RequestParam(value = "newsletterName") String newsletterName) {
        ...
        Newsletter newsletter = newsletterRepositoryImpl.findByName(newsletterName);
